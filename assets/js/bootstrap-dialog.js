...
var dialog = new BootstrapDialog.show({
                 ...
                 //size: BootstrapDialog.SIZE_SMALL,        //<--works as modal-sm
                  ...
                  closable: true,
                  //cssClass: 'modal-dialog-scrollable modal-lg fucku', //modal-dialog-centered, modal-dialog-scrollable, modal-sm, modal-lg, modal-xl
...
(function (root, factory) {
    ...
    BootstrapDialog.SIZE_SMALL = 'size-small';  // size-wide is equal to modal-sm
    BootstrapDialog.SIZE_WIDE = 'size-wide';    // size-wide is equal to modal-lg
    BootstrapDialog.SIZE_EXTRAWIDE = 'size-extrawide';    // size-extrawide is equal to modal-xl
