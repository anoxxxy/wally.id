...
(function($, undefined) {
  $.fn.drawPieChart = function(data, options) {
    var $this = this,
      ...
      settings = $.extend({
        ...
        baseColor: "#fff",
        baseOffset: 15,
        edgeOffset: 12,//offset from edge of $this
    ...
    for (var i = 0, len = data.length; i < len; i++){
      ...
      lp.setAttribute("data-pie-title", data[i].title);
      //lp.setAttribute("data-title", settings.lightPieDataTitle);
      //lp.setAttribute("data-content", settings.lightPieDataContent);
    ...
    function pathMouseEnter(e){
      ...
      $tip.html(data[index].title + ": <br>" + data[index].value).fadeIn(200);
    ...
    function pathMouseMove(e){
      ...
      var left_ = e.pageX - $tip.width() / 2 + settings.tipOffsetX;
      if (left_ < 0)
        left_ = 0;
      $tip.css({
    ...
    function pathClick(e){
      ...
      console.log('targetGroup: ', targetGroup.getBoundingClientRect());

      var page_ = targetGroup.getBoundingClientRect();
      ...
      $tip[0].style.left  = page_.x -15 + 'px';
      $tip[0].style.top  = page_.y +65 + 'px';
      */
  ...
  //$('body').popover('.pieLegend li, .lightPie', function(e){
  /*
  $('body .pieLegend li').popover({
    title: 'hej', 
    content: 'content: '+ $(this).attr('data-content'),
    //container: 'body', 
    trigger: 'hover',
  })
  */
