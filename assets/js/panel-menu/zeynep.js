...
(function ($, pluginName) {
  ...
  Plugin.prototype.init = function () {
    ...
    this.options.htmlClass && !$('body').hasClass('zeynep-initialized') && $('body').addClass('zeynep-initialized')
  ...
  Plugin.prototype.open = function () {
    ...
    this.options.htmlClass && $('body').addClass('zeynep-opened')
  ...
  Plugin.prototype.close = function (disableEvent) {
    ...
    this.options.htmlClass && $('body').removeClass('zeynep-opened')
  ...
  Plugin.prototype.destroy = function () {
    ...
    this.options.htmlClass && $('body').removeClass('zeynep-initialized')
