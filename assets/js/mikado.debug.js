...
var trimmedNode = node.trim();
var firstTag = trimmedNode.substring(trimmedNode.indexOf("<") + 1, trimmedNode.indexOf(">")).split(" ")[0];
var tmp = document.createElement(tagMapping[firstTag] || "div");
