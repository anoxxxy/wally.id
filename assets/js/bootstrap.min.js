...
!(function (t, e) {
  ...
  var Ie = "tooltip",
    ...
    Qe = {
      ...
      whiteList: {
        ...
        input: ["class", "id", "type", "value", "min", "max"],
        label: ["class", "id", "for"],
        li: [],
        ol: [],
        option: ["value"],
      ...
      return (
        ...
        (e._getConfig = function (t) {
          ...
          return (
            ...
            "number" == typeof t.footer && (t.footer = t.footer.toString()),
  ...
  var Ye = "bs.popover",
    ...
    Xe = a({}, Ve.Default, {
      ...
      footer: "",
      template:
        '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div><div class="popover-footer hidden"></div></div>',
    }),
    ...
    Je = (function (t) {
      ...
      return (
        ...
        (a.setContent = function () {
          ...
          var ef = this._getFooter();
          /*
          console.log('----------------ef-------------', ef);
          console.log('----------------t-------------', t);
          console.log('----------------t.find-------------', t.find(".popover-footer"));
          console.log('----------------this.element-------------', this.element);
          */

          if(ef !== undefined) {
            "function" == typeof ef && (ef = ef.call(this.element)),
              this.setElementContent(t.find(".popover-footer"), ef);
            if (t.find(".popover-footer").html().length > 0 || ef.length > 0)
              t.find(".popover-footer").removeClass('hidden');
          }
        }),
        ...
        (a._getFooter = function () {
          return (
            this.element.getAttribute("data-footer") || this.config.footer
          );
        }),
