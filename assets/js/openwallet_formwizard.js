(function () {
  ...
  login_wizard.validateLogin = function (loginType, walletType, signatures) {
    ...
    try {
      ...
      if(passwordHasError)
        login_wizard.errorMessage += '<p class="mt-2">&#8226; Password must be between 16-255 chars and must include minimum 1 number, 1 uppercase letter, 1 lowercase letter and 1 special character from \"!#$€%&\'()*+,-./:;<=>?@[\]^_`{|}~¤¨½§ </p>';
