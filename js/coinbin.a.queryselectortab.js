	...
	*/
	...
	$(".optionsCollapse").click(function(){
		if($(".optionsAdvanced",$(this).parent()).hasClass('hidden')){
			$(".optionsCollapseIcon",$(this).parent()).removeClass('bi-caret-down-fill').addClass('bi-caret-up-fill');
			$(".optionsAdvanced",$(this).parent()).removeClass("hidden");
		} else {
			$(".optionsCollapseIcon",$(this).parent()).removeClass('bi-caret-up-fill').addClass('bi-caret-down-fill');
	...
	$(".showKey").click(function(){
		...
		if ($(this).data("hidden") === false) {
			$(this).parent().parent().children(':first-child').attr('type','password');
			$(this).data("hidden", true);
			$(this).html('<i class="bi bi-eye-fill"></i>');
		} else {
			$(this).parent().parent().children(':first-child').attr('type','text');
	...
	function hideAllPages(){
		...
		tabPages.forEach(allTabs => {
            ...
            console.log("hideAllPages --> active pages removed!");
        });
	}
	function showPage(pageHash){
		console.log('showPage: '+ pageHash);
...
*/
	...
	$('a[data-pagescroll="page_tab"]').on('click', function(e) {
		...
		//active tab content on clicked link
		(this.hash).classList.add("active");
...
//check if anchor/Hash exists among available pages!
	function checkNavigation(anchorHash) {
...
*/
	 ...
	 */
	 if(checkNavigation(history.state)) {
	 	console.log('page found! history.state');
	 	landingPage(history.state);
	 	scrollFunction(history.state);
	 }else if(checkNavigation(location.hash)) {
...
/*
      ...
      function landingPage(pageHash, show=false) {
