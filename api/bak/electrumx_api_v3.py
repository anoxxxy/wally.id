#!/usr/bin/python
#Connect to the ElectrumX TCP server with Python v3 API
#@Created by Anoxy(Anoxxxy) anoxydoxy@gmail.com 
#Python script to communicate with the ElectrumX TCP server.
#May be tweaked!
...
#127.0.0.1:9998/api?method=blockchain.address.listunspent&params=KJ2MGS3jq4DPkVmE1ephMCbT7ojDcDSJRG

HOST_ELECTRUMX = "45.13.232.131"	#HOST name for the ElectrumX server
PORT_ELECTRUMX = 50001				#PORT number for the ElectrumX server
